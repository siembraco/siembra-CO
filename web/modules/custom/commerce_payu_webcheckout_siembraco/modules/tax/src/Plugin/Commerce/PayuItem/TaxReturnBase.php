...
namespace Drupal\commerce_payu_webcheckout_siembraco_tax\Plugin\Commerce\PayuItem;
...
class TaxReturnBase extends PayuItemBase implements ContainerFactoryPluginInterface {
   ...
   * @param \Drupal\commerce_payu_webcheckout_siembraco\PayuCurrencyFormatterInterface $currency_formatter
   *   A Payu currency formatter.
   */
