...
namespace Drupal\commerce_payu_webcheckout_siembraco\EventSubscriber;

use Drupal\commerce_payu_webcheckout_siembraco\Event\HashPresaveEvent;
use Drupal\commerce_payu_webcheckout_siembraco\PayuCurrencyFormatterInterface;
...
class HashPresaveEventSubscriber implements EventSubscriberInterface {
   ...
   *
   * @var \Drupal\commerce_payu_webcheckout_siembraco\PayuCurrencyFormatterInterface
   */
  protected $formatter;
   ...
   * @param \Drupal\commerce_payu_webcheckout_siembraco\PayuCurrencyFormatterInterface $formatter
   *   The Payu Currency formatter service.
   ...
   *
   * @param \Drupal\commerce_payu_webcheckout_siembraco\HashPresaveEvent $event
