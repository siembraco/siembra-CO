...
namespace Drupal\commerce_payu_webcheckout_siembraco\Plugin\Commerce\PaymentGateway;

use Drupal\commerce_payment\PaymentMethodTypeManager;
use Drupal\commerce_payment\PaymentTypeManager;
use Drupal\commerce_payment\Plugin\Commerce\PaymentGateway\OffsitePaymentGatewayBase;
use Drupal\commerce_payu_webcheckout_siembraco\PaymentParserInterface;
 ...
 *   },
 *   forms = {
 *     "offsite-payment" = "Drupal\commerce_payu_webcheckout_siembraco\PluginForm\PayuWebcheckoutPaymentForm",
 *   },
...
class PayuWebcheckout extends OffsitePaymentGatewayBase implements ContainerFactoryPluginInterface {
   ...
   *
   * @var Drupal\commerce_payu_webcheckout_siembraco\PaymentParserInterface
   */
   ...
   *   Drupal renderer service.
   * @param \Drupal\commerce_payu_webcheckout_siembraco\PaymentParserInterface $payment_parser
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['#attached']['library'][] = 'commerce_payu_webcheckout_siembraco/configuration_helper';
    $form['#attached']['drupalSettings']['commerce_payu_webcheckout_siembraco']['configuration_helper']['default_settings'] = $default_configuration;
    return $form;
  }
