...
namespace Drupal\commerce_payu_webcheckout_siembraco\Plugin;

use Drupal\commerce_payu_webcheckout_siembraco\Annotation\PayuItem;
...
class PayuItemManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    ...
    $this->setCacheBackend($cache_backend, 'commerce_payu_webcheckout_siembraco_item_plugins');
